...
Purpose
-------
Compare different preprocessing resolutions for the same IVD ROI.
...
All non-native RAW representations:
...
def extract_padded_crop(
    ...
    Padding is applied independently on all four sides.

    The resulting crop is naturally rectangular.

    IMPORTANT:
        We do NOT force this native crop to be square.
    """
...
# ============================================================================
# ASPECT-RATIO-PRESERVING RESIZE + SQUARE PADDING
# ============================================================================
...
def process_ivd(
    ...
    # ------------------------------------------------------------------------
    # NORMALIZE NATIVE CROP TO 8-BIT
    # ------------------------------------------------------------------------
    ...
    # Native -> 1024 x 1024
    #
    # Native is rectangular, therefore:
    #
    #     preserve aspect ratio
    #     + square padding
    # ------------------------------------------------------------------------
    ...
    for resolution in (
        ...
        if resolution == 1024:
            ...
            # Therefore aspect ratio is already preserved.
...
def main():
    ...
    print("=" * 78)
    print("DISC ROI RESOLUTION EXPERIMENT")
    print("=" * 78)
    ...
    print(
        "11. Native crop retains its natural rectangular aspect ratio."
    )

    print(
        "12. Non-native RAW images preserve aspect ratio and use square padding."
    )

    print(
        "13. UPSCALED images are all 1024 × 1024."
    )

    print(
        "14. No direct rectangular-to-square stretching is performed."
    )
