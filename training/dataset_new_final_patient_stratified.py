...
from configs.paths import NEW_FINAL_PATIENT_STRATIFIED_DATASET_CSV


# =============================================================================
# PFIRRMANN DATASET - NEW FINAL PATIENT STRATIFIED EXPERIMENT
# =============================================================================
class PfirrmannDatasetNewFinal(Dataset):
    """
    Dataset for single-disc Pfirrmann grading using the NEW FINAL dataset.

    Each row in dataset_new_final_patient_stratified.py represents one disc sample.
    ...
    def __init__(
        self,
        csv_path=NEW_FINAL_PATIENT_STRATIFIED_DATASET_CSV,
        split=None,
    ):
        super().__init__()
