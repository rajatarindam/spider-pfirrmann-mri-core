...
from configs.training_config_new_final_patient_stratified import (
    BATCH_SIZE,
    NUM_WORKERS,
    PIN_MEMORY,
    NUM_EPOCHS,
...
from training.dataset_new_final_patient_stratified import PfirrmannDatasetNewFinal
...
CHECKPOINT_DIR = paths.NEW_FINAL_PATIENT_STRATIFIED_CHECKPOINT_DIR
LOG_DIR = paths.NEW_FINAL_PATIENT_STRATIFIED_LOGS_DIR
